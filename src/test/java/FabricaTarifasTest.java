...
public class FabricaTarifasTest {
    ...
    @Test
    public void getTarifaBaseTest(){ Assert.assertEquals(new TarifaBasica(0.15f), fabricaTarifas.getTarifaBase(TipoTarifa.Base.BASICA)); }

    @Test
    public void getTarifaExtraTardesTest(){ Assert.assertEquals(new TarifaHoras(new TarifaBasica(0.15f),0.05f, 16, 20), fabricaTarifas.getTarifaExtra(new TarifaBasica(0.15f),TipoTarifa.Extra.TARDES)); }

    @Test
    public void getTarifaExtraDomingosTest(){ Assert.assertEquals(new TarifaDiasSemana(new TarifaBasica(0.15f),0.05f, 7), fabricaTarifas.getTarifaExtra(new TarifaBasica(0.15f),TipoTarifa.Extra.DOMINGOS)); }
}
